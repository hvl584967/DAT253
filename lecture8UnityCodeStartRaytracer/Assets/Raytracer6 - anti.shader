...
Shader "Unlit/SingleColor"
{
    SubShader
    {
        Pass
        {
            ...
            {
                sphere sph;
                if (i == 0) { sph.center = float3( 0, 0, -1); sph.radius = 0.5;
                    //sph.materialtype = 0; sph.matproperties.xyz = float3(0.8, 0.3, 0.3);
                }
                if (i == 1) { sph.center = float3( 0,-100.5, -1); sph.radius = 100;
                    //sph.materialtype = 0; sph.matproperties.xyz = float3(0.8, 0.8, 0.0);
                }
                if (i == 2) { sph.center = float3( 1, 0, -1); sph.radius = 0.5;
                    //sph.materialtype = 1; sph.matproperties.xyz = float3(0.8, 0.6, 0.2);
                }
                if (i == 3) { sph.center = float3(-1, 0, -1); sph.radius = 0.5;
                    //sph.materialtype = 1; sph.matproperties.xyz = float3(0.8, 0.8, 0.8);
                }
                return sph;
            }
